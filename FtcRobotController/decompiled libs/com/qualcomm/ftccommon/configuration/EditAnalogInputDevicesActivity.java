...
extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput0);
        this.b = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout, true);
        TextView textView = (TextView)this.b.findViewById(R.id.port_number_analogInput);
        textView.setText((CharSequence)"0");
        LinearLayout linearLayout2 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput1);
        this.c = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout2, true);
        TextView textView2 = (TextView)this.c.findViewById(R.id.port_number_analogInput);
        textView2.setText((CharSequence)"1");
        LinearLayout linearLayout3 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput2);
        this.d = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout3, true);
        TextView textView3 = (TextView)this.d.findViewById(R.id.port_number_analogInput);
        textView3.setText((CharSequence)"2");
        LinearLayout linearLayout4 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput3);
        this.e = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout4, true);
        TextView textView4 = (TextView)this.e.findViewById(R.id.port_number_analogInput);
        textView4.setText((CharSequence)"3");
        LinearLayout linearLayout5 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput4);
        this.f = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout5, true);
        TextView textView5 = (TextView)this.f.findViewById(R.id.port_number_analogInput);
        textView5.setText((CharSequence)"4");
        LinearLayout linearLayout6 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput5);
        this.g = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout6, true);
        TextView textView6 = (TextView)this.g.findViewById(R.id.port_number_analogInput);
        textView6.setText((CharSequence)"5");
        LinearLayout linearLayout7 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput6);
        this.h = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout7, true);
        TextView textView7 = (TextView)this.h.findViewById(R.id.port_number_analogInput);
        textView7.setText((CharSequence)"6");
        LinearLayout linearLayout8 = (LinearLayout)this.findViewById(R.id.linearLayout_analogInput7);
        this.i = this.getLayoutInflater().inflate(R.layout.analog_input_device, (ViewGroup)linearLayout8, true);
        TextView textView8 = (TextView)this.i.findViewById(R.id.port_number_analogInput);
    ...
    private void a(LinearLayout linearLayout) {
        TextView textView = (TextView)linearLayout.findViewById(R.id.port_number_analogInput);
    ...
    implements TextWatcher {
        ...
        private a(View view) {
            TextView textView = (TextView)view.findViewById(R.id.port_number_analogInput);
        ...
        public void afterTextChanged(Editable editable) {
            DeviceConfiguration deviceConfiguration = (DeviceConfiguration)EditAnalogInputDevicesActivity.this.j.get(this.b);
